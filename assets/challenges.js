...
function sorting(input) {
  ...
  do {
    ...
    //     let thisArr = freqArr.slice(0, endOfQuarter1 - 1)
    //     foundFreq = thisArr.find(x => x == currfreq)
    //   } else {
    //     let thisArr = freqArr.slice(endOfQuarter1, middle)
    //     foundFreq = thisArr.find(x => x == currfreq)
    //   }
    // }
    // if (currfreq >= freqArr[middle]) {
    //   if (currfreq >= freqArr[endOfQuarter3 - 1]) {
    //     let thisArr = freqArr.slice(endOfQuarter3, freqArr.length)
    //     foundFreq = thisArr.find(x => x == currfreq)
    //   } else {
    //     let thisArr = freqArr.slice(middle + 1, endOfQuarter3 - 1)
    //     foundFreq = thisArr.find(x => x == currfreq)
    //   }
    // }
    ...
    switch (true) {
      ...
      case (currfreq >= freqArr[freqArr.length - 1]):
        if (currfreq == freqArr[freqArr.length - 1]) {
          found = true
          return currfreq
        }
        freqArr.push(currfreq)
