...
//           middle - 1
//         }
//         while (currfreq >= freqArr[middle - 1])
...
let input = [62, -2, 45, 10, -52, 86, 50, 51, -80, -44, 15, 31, -44, -19, -46, -34, 43, 16, -97, -10, -20, -29, 43, -84, -7, 70]
  ...
  do {
    ...
    switch (true) {
      case (freqArr.length == 0):
        ...
        break;
      case (freq <= freqArr[0]):
        freqArr.unshift(freq)
        currfreq += freq
        break;
      case (freq >= freqArr[freqArr.length - 1]):
        freqArr.push(freq)
        currfreq += freq
        break;
